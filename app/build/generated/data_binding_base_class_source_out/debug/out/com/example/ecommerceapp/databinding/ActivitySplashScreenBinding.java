...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final MotionLayout splashMotionLayout;

  private ActivitySplashScreenBinding(@NonNull MotionLayout rootView,
      @NonNull ImageView splashImageView, @NonNull MotionLayout splashMotionLayout) {
    this.rootView = rootView;
    this.splashImageView = splashImageView;
    this.splashMotionLayout = splashMotionLayout;
  }
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MotionLayout splashMotionLayout = (MotionLayout) rootView;

      return new ActivitySplashScreenBinding((MotionLayout) rootView, splashImageView,
          splashMotionLayout);
    }
